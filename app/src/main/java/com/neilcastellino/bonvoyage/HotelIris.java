...
public class HotelIris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hotel_activity_iris);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        name = (TextView) findViewById(R.id.hi_name);
        price = (TextView) findViewById(R.id.hi_price);
        ...
        book = (Button) findViewById(R.id.hi_btn);
        ...
        if (email == "ERROR") {
            ...
            book.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(HotelIris.this, Date_andDay.class);
